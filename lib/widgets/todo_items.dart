      ...
      child: ListTile(
        ...
        trailing: Container(
          ...
          decoration: BoxDecoration(
            color: Color.fromARGB(255, 119, 118, 151),  // Set background color of the delete button container to red
          ...
          child: IconButton(
            ...
            icon: Icon(
              Icons.delete,
              size: 18,
              color: Color.fromARGB(255, 2, 3, 75),  // Set icon color to white
            ),
          ),
        ),
      ),
